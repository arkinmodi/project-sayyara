...
\begin{table}[H]
	\begin{tabular}{|l|l|l|}
		...
		% \hline
		% shop\_id             & String                & ID of shop Employee is registered under \\
		\hline
		shop                 & Shop                  & Shop Employee is registered under     \\
		\hline
...
\begin{table}[H]
	\begin{tabular}{|l|l|l|}
		...
		\hline
		quotes               & List$<$Quote$>$       & Quotes assigned to the Customer       \\
		\hline
		vehicles             & List$<$Vehicle$>$     & Vehicles assigned to the Customer     \\
		\hline
	\end{tabular}
\end{table}
