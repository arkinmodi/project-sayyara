...
\begin{description}
	...
	\item The format of server-side responses
	\item The styling of UI forms and components
	\item The formatting of UI forms and components
\end{description}
...
\begin{description}
	...
	\item The application will be built-upon the NextJS framework
	\item The application will use Prisma for object-relation mapping (ORM)
	\item There will always be a source of input data external to the system
\end{description}
