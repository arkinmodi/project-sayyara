...
The Home Page features all the auto shops that match the search criteria. Users can search by shop
name or service name. There are also filters for OEM parts or aftermarket parts, new parts or used
parts, and also a location filter. Users can view the shop profile by clicking one of the search
entries.
\begin{figure}[H]
	\centering
...
The Manage Employees page is where shop owners can manage their employees by searching for their
employee, viewing employee details such as name, phone number, email, etc. Shop owners can also
suspend employees from this page.
...
validated, the user can successfully sign up.
