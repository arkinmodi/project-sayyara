...
processes involved in a typical auto repair and maintenance service experience. services, which can
either be canned services or custom services. All functionality of the system has been defined in
the SRS \url{https://github.com/arkinmodi/project-sayyara/blob/main/docs/SRS/SRS.pdf} and
everything not included in the SRS is not part of the scope.
