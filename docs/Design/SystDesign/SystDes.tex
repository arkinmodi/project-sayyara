...
The system is designed to connect vehicle owners to independent shop owners, providing users with
the ability to communicate with one another, and respectively view and manage the interactions and processes involved in a typical auto repair and maintenance service experience.  
services, which can either be canned services or custom services. All functionality of the system
has been defined in the SRS
