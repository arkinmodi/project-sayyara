...
the ability to communicate with one another and create, schedule and see pricing for vehicle
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth/2]{./diagrams/ContextDiagram.png}
