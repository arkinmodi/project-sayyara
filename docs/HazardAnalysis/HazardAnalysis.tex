...
\begin{enumerate}[SR\arabic*.]
	\item The device shall protect personally identifiable information (PII) by encrypting information both
	      at rest and in transit. \\ \emph{Rationale:} \\ \emph{Associated Hazards:} \item
\end{enumerate}
