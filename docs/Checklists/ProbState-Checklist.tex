...
\begin{itemize}
	...
	\item The source for the document
	      \begin{todolist}
		      \item The source is text-based, like \LaTeX{}, \href{https://en.wikipedia.org/wiki/Markdown} {Markdown},
	...
	\item Overall qualities of documentation
	      \begin{todolist}
		      \item Scope is clear
		      \item Document is abstract (for instance, it does not mention the programming language (unless this is a
		      true constraint) or the algorithm choices (unless the algorithm is the ``what'' rather than the
		      ``how''))
