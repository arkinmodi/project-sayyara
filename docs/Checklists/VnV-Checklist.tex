...
\begin{itemize}
	...
	\item Grammar, spelling, presentation
	      \begin{todolist}
		      ...
		      \item No grammar mistakes (review, ask someone else to review (at least a few sections))
	...
	\item LaTeX
	      \begin{todolist}
		      \item Template comments do not show in the pdf version, either by removing them, or by turning them off.
	...
	\item Overall qualities of documentation
	      \begin{todolist}
		      ...
		      \item Plans for what to do with description data (performance, usability, etc). This may involve saying
