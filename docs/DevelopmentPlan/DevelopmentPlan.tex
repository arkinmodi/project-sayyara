...
publicly on GitHub. The most stable up to date version of our application will be on ``main''
...
\begin{enumerate}
  ...
  \item Add ``need review'' label (if ready for review)
  \item Assign assignees and reviewers
  \item Pass any pull request pipelines in our CICD setup
