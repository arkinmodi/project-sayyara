...
be easily accessed by searching for issues with the ``meeting notes'' tag.

Additional meetings with the supervisor will be held on a need to meet basis.

\section{Team Communication Plan}

The team will communicate through these methods:
...
\begin{table}[H]
	...
	\begin{tabular}{|p{0.3\textwidth}|p{0.6\textwidth}|}
		\hline
		\textbf{Communication Method} & \textbf{Use Case(s)} \\
		\hline
		Discord & Quick communication, communication with supervisor \\
		\hline
		Github Issues & General (non-urgent) communication, organizing tasks, meeting agendas \\
		\hline
	\end{tabular}
\end{table}
