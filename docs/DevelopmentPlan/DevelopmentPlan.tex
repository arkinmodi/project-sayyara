...
package to quickly enable the creating of PWA's in Next.js. We have decided to create a PWA since
this was one of the key application attributes that the supervisor required.
...
We will be using Prisma as our ORM (Object-relational mapping) and MySQL as our database. We have
decided to use a SQL database due to our data having relations. MySQL was specifically chosen due to
past experience within the team. In a NoSQL database, relations are harder to maintain and/or
inefficient to query. The use of Prisma is due to past experience within the team and a strong
reputation within the web development world.
...
All CICD pipelines will be created using GitHub Actions. This was chosen due to GitHub Actions
...
Prettier. Prettier is an industry standard code formatter and wide agreed upon default
configuration.

For our \LaTeX{} docs, we will be using latexindent.pl. latexindent.pl is a popular \LaTeX{} code
formatted. The primary use will be for managing our whitespace to ensure consistent readability in
