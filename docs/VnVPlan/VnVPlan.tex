...
\begin{enumerate}
	...
	Input: Employee signs up using valid information

	Output: Employee account is created and associated with the shop ID that was entered

	Test Case Derivation: The system shall allow the employee to create an account with the information provided

	How test will be performed: The tester will use a shop ID displayed on the shop owner's employee profile page and go through the sign up flow as an employee. The tester will confirm that the employee account has the appropriate privileges
	...
	Input: Employee signs up using invalid information
	...
	How test will be performed: The tester will use invalid information to sign up as an employee
...
This section will contain tests covering the ``Employee Management'' requirements defined in the
\href{https://github.com/arkinmodi/project-sayyara/blob/main/docs/SRS/SRS.pdf}{SRS}. These
tests were chosen based on common user flows.
...
\begin{enumerate}
	...
	\item \textbf{FRT-M7-1}
	      ...
	      Input: Create employee account request with valid information

	      Output: Create the employee account

		  Test Case Derivation: Employee at a shop wants to sign up for an account

	      How test will be performed: Jest will send a create employee account request with valid information
	...
	Input: Create employee account request with invalid information

	Output: Request is rejected

	Test Case Derivation: Employee at a shop wants to sign up for an account

	How test will be performed: Jest will send a create employee account request with invalid information
	...
	How test will be performed: Jest will send a get employees request with a invalid shop ID
