...
The following system tests are for functional requirements, as stated in the defined in the
\href{https://github.com/arkinmodi/project-sayyara/blob/main/docs/SRS/SRS.pdf}{SRS}. These
subsections follow the same layout as the SRS to ensure all requirements are covered. We have also
labelled each test case after its relevant business event.
