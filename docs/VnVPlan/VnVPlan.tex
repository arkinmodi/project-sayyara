...
\begin{enumerate}
	...
	\item \textbf{FRT-BE18}
	      ...
	      How test will be performed: Through Jest we will call the endpoint for deleting an appointment
	...
	\item \textbf{FRT-BE19}
	      ...
	      How test will be performed: Through Jest we will call the endpoint for getting a work order
	...
	\item \textbf{FRT-BE21}
	      ...
	      How test will be performed: Through Jest we will call the endpoint for updating a work order
	...
	\item \textbf{FRT-BE22}
	      ...
	      How test will be performed: Through Jest we will call the endpoint for completing an appointment
