...
\begin{enumerate}
	...
	\item \textbf{NFRT-SR1-1}
	      ...
	      Initial State: Two created account with both containing an appointment

	      Input/Condition: The appointment not belonging to the account will be looked by appointment ID
	...
	\item \textbf{NFRT-SR2-2}
	      ...
	      Input/Condition: A HTTP request to the application's backend to get the available tim slots using
