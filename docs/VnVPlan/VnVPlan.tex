...
\begin{enumerate}
	...
	\item \textbf{NFRT-SR1-1}
	      ...
	      Input/Condition: The appointment not belonging to the account will be searched for by appointment
	      ID
	...
	\item \textbf{NFRT-SR1-2}
	      ...
	      Input/Condition: A HTTP request to the application's backend to get the appointment by appointment
	      ID

	      Output/Result: The request is rejected with a 403 Forbidden error message

	      How test will be performed: Through Jest a HTTP request will be sent to the server

	\item \textbf{NFRT-SR2-1}

	      Type: Dynamic, Manual

	      Initial State: One Shop Owner account and two Customer account with one customer having an
	      appointment at the shop registered under the Shop Owner account

	      Input/Condition: Viewing available time slots as the Customer without an appointment and again as
	      the Shop Owner
	...
	\item \textbf{NFRT-SR2-2}
	      ...
	      Input/Condition: A HTTP request to the application's backend to get the available time slots using
	      ...
	      How test will be performed: Through Jest a HTTP request will be sent to the server as both the
