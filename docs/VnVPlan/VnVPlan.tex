...
\begin{enumerate}
	...
	\item \textbf{FRT-BE28-1}
	      ...
	      Input: Shop Owner sets available services
	      ...
	      How test will be performed: The user will search for shop services through the user interface

	\item \textbf{FRT-BE29-1}

	      Control: Manual

	      Initial State: Customer Account searches for auto repair or maintenance services
	...
	\item \textbf{FRT-BE30-1}
	      ...
	      How test will be performed: The user will update the details of a shop service through the user
	      interface
	...
	\item \textbf{FRT-BE31-1}
	      ...
	      How test will be performed: The user will delete a shop service through the user interface
