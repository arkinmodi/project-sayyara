...
\begin{enumerate}
	\item \textbf{FRT-BE32}\\
	      Control: Manual\\
	      Initial State: Shop Owner/Employee Account with a registered shop\\
	      Input: The user attempts to view a list of shops, using the parameters of distance, postal code, and/or shop name\\
	      Output: A output list of shops based on the input parameters\\
