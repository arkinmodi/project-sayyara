...
This section will contains tests covering the ``Employee Management'' requirements defined in the
\href{https://github.com/arkinmodi/project-sayyara/blob/main/docs/SRS/SRS.pdf}{SRS}.
...
\begin{enumerate}
	...
	\item \textbf{FRT-BE24-1}
	      ...
	      Initial State: Shop owner with no employees invited to shop yet
	...
	\item \textbf{FRT-BE24-2}
	      ...
	      Initial State: Employee with invitation email
	...
	\item \textbf{FRT-BE25-1}
	      ...
	      Initial State: Shop owner with employees listed under the shop
