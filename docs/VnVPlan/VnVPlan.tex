...
\begin{enumerate}
	...
	\item \textbf{FRT-BE8-2}
	      ...
	      Initial State: Customer Account with quotes requests which have been closed and were initiated by the account
	...
	\item \textbf{FRT-BE8-4}
	      ...
	      Initial State: Shop Owner/Employee Account with closed quotes requests that were assigned to the shop
