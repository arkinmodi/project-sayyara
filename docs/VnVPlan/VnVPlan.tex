...
\begin{enumerate}
	...
	Initial State: Vehicle Owner got a quote from an auto shop

	Input: Vehicle Owner fills out service request information and selects an available appointment
	time slot

	Output: A new appointment is created with service details

	Test Case Derivation: The system shall allow the user to book an appointment

	How test will be performed: Through Jest we will call the endpoint for creating an appointment
	...
	Initial State: Shop Owner/Shop Employee account with appointment to be scheduled

	Input: Shop Owner/Shop Employee fills out customer information, service request information and
	selects an available appointment time slot
	...
	Initial State: Vehicle Owner has a service appointment scheduled

	Input: Vehicle Owner selects an appointment to edit and selects a new available timeslot for the
	appointment

	Output: The appointment booking is updated to the new timeslot

	Test Case Derivation: The system shall allow the user to edit an appointment

	How test will be performed: Through Jest we will call the endpoint for updating an appointment
	timeslot
	...
	Input: Shop Owner/Shop Employee selects an appointment to edit and selects a new available timeslot
	for the appointment
	...
	Input: Shop Owner/Shop Employee selects an appointment to edit service details

	Output: The appointment booking is updated with the updated service details

	Test Case Derivation: The system shall allow the user to edit an appointment

	How test will be performed: Through Jest we will call the endpoint for updating appointment service
	details
	...
	Input: Vehicle Owner selects an appointment to cancel

	Output: The appointment booking is cancelled

	Test Case Derivation: The system shall allow the user to cancel an appointment

	How test will be performed: Through Jest we will call the endpoint for cancelling an appointment
	...
	Input: Shop Owner/Shop Employee selects an appointment to cancel
	...
	Input: Shop Owner sets appointment availabilities

	Output: The appointment availability is updated in the database

	Test Case Derivation: The system shall allow the user to set appointment availabilities

	How test will be performed: Through Jest we will call the endpoint for setting appointment
	availabilities
