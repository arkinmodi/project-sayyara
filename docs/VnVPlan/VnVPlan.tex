...
\begin{landscape}
	...
	\begin{longtable}{|l|cc|}
		\caption{Traceability Between Functional Test Cases and Functional Requirements, BE32 to 33}   \\
		\hline
		\textbf{Test IDs}   & \multicolumn{2}{c|}{\textbf{Functional Requirement IDs}}                 \\
		\hline
		~                   & \textbf{BE32}                                            & \textbf{BE33} \\
		\hline
		\textbf{FRT-BE32-1} & X                                                        & ~             \\
		\textbf{FRT-BE33-1} & ~                                                        & X             \\
		\hline
