...
\begin{longtable}{p{0.2\textwidth} p{0.2\textwidth} p{0.5\textwidth}}
	...
	March 4, 2023    & Arkin Modi            & Update Employee Management System Tests and add Unit Tests \\
	\bottomrule
\end{longtable}
...
\begin{enumerate}
	...
	\item \textbf{FRT-BE24-1}
	      ...
	      profile page and go through the sign up flow as an employee. The tester will confirm that the
...
\begin{enumerate}
	...
	\item \textbf{FRT-M7-2}
	      ...
	      How test will be performed: Jest will send a create employee account request with invalid
	      information
