...
by the TAs of the course. The verification will be done by going through the MG and MIS checklist
and ensure that all the modules are completed and fulfill the corresponding requirements.
