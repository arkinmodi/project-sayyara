...
\begin{enumerate}
	...
	Initial State: Customer account which has initiated a quote request with an auto shop

	Input: Enters service request information and selects an available appointment time slot

	Output: A new appointment is created with service details linked to the quote. Shop Owner/Employee Accounts will
