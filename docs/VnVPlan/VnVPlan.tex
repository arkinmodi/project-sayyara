...
\begin{enumerate}
	...
	\item \textbf{FRT-M3-9}
	      ...
	      Test Case Derivation: A user wants to authorize themselves in order to view their data (e.g., appointments,
	      work orders, etc.)
	...
	\item \textbf{FRT-M3-10}
	      ...
	      Test Case Derivation: A user wants to authorize themselves to view their data (e.g., appointments,
	      work orders, etc.)
...
\begin{enumerate}
	...
	\item \textbf{FRT-M4-1}
	      ...
	      Initial State: A customer, a vehicle, a shop, a shop owner, and a custom service exist
