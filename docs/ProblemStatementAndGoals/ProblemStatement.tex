...
\begin{table}[hp]
	...
	\begin{tabularx}{\textwidth}{llX}
		...
		March 14, 2023     & Joy Xiao              & Update problem statement                  \\
		\bottomrule
	\end{tabularx}
\end{table}
...
The purpose of this project is to solve the issues with the current scheduling of appointments for
auto maintenance and repairs. The team would develop a website for customers to easily find auto
repair shops that match their criteria, compare prices between shops, chat with auto shop
representatives, book appointments, and manage their appointments.

The website will also allows auto repair shop staff to easily manage the shop appointments, shop
services, work orders, allow employees to sign up and have limited access to manage the shop, and
easily update shop details.
