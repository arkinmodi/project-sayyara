...
This section focuses on the general equations and laws that \famname{} is based on. \plt{Modify the
	examples below for your problem, and add additional models as appropriate.}
...
\noindent \begin{itemize}
	...
	\item[LC\refstepcounter{lcnum}\thelcnum\label{LC_meaningfulLabel}:] \plt{If there is a ranking of
			variabilities, or combinations of variabilities, that are more likely, this information can be
			included here.}
