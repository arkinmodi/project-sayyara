...
\begin{enumerate}[resume*=business_events]
	...
	\item The user wants to edit an appointment
	      \begin{enumerate}[VP\arabic*.]
		      ...
		      \item Viewpoint: Auto Repair Shop Owner
		            \begin{enumerate}
			            \item The system shall allow the user to accept an appointment and move the appointment to a scheduled
			                  state and notify the user that the appointment was moved to scheduled
			            \item The system shall allow the user to move an appointment to an in progress state and notify the user
			                  that the appointment was moved to in progress
