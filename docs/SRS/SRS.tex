...
$(\exists a \in \text{users} \and a.\text{role} \in \text{owner} | \forall x \in \users | x.\text{shop} = a.\text{shop} \bullet a.\text{edit}(x) \and a.\text{view}(x.\text{profile}) \Rightarrow true)$
