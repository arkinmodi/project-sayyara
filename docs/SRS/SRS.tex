	...
	\item The user wants to view their shop's profile
	      \begin{enumerate}[VP\arabic*.]
		      ...
		      \item Viewpoint: Auto Repair Shop Employee
		            ...
		            \end{enumerate}
	      \end{enumerate}
	\item The user wants to add or update their shop's profile
	      \begin{enumerate}[VP\arabic*.]
		      \item Viewpoint: Vehicle Owner
		            \begin{enumerate}
			            \item[] N/A
...
\begin{enumerate}[resume*=business_events]
	\item The user wants to view their employee profile
	      \begin{enumerate}[VP\arabic*.]
		      ...
		      \item Viewpoint: Auto Repair Shop Owner
		            \begin{enumerate}
			            \item The system shall show the user all employees who currently are registered under the user's shop
			            \item The system shall allow the user to select an employee to see more in-depth detail of the specific
			                  employee
		            \end{enumerate}
		      \item Viewpoint: Auto Repair Shop Employee
		            \begin{enumerate}
			            \item The system shall show the user their own employee information
			            \item The system shall not show the user any other employee information
		            \end{enumerate}
	      \end{enumerate}
	\item The user wants to add an employee to the shop
	      \begin{enumerate}[VP\arabic*.]
		      \item Viewpoint: Vehicle Owner
		            \begin{enumerate}
			            \item[] N/A
		      ...
		      \item Viewpoint: Auto Repair Shop Owner
		            \begin{enumerate}
			            \item The system shall allow the user to enter a name
			            \item The system shall allow the user to enter a phone number
			            \item The system shall allow the user to enter an email
			            \item The system shall create a profile for the employee, based on the fields above
		            \end{enumerate}
		      \item Viewpoint: Auto Repair Shop Employee
		            \begin{enumerate}
			            \item[] N/A
		            \end{enumerate}
	      \end{enumerate}
	\item The user wants to delete an employee from the shop
	      \begin{enumerate}[VP\arabic*.]
		      \item Viewpoint: Vehicle Owner
		            \begin{enumerate}
			            \item[] N/A
		      ...
		      \item Viewpoint: Auto Repair Shop Owner
		            \begin{enumerate}
			            \item The system shall allow the user to select an employee
			            \item The system shall prompt the user if they want to proceed with deleting the selected employee
			            \item The system shall remove the employee from the list of employees associated with the shop
		            \end{enumerate}
		      \item Viewpoint: Auto Repair Shop Employee
		            \begin{enumerate}
			            \item[] N/A
