...
\begin{table}[hp]
	...
	\begin{tabularx}{\textwidth}{llX}
		...
		October 5, 2022    & Leon So               & Add self reflection in Appendix                                                    \\
		\bottomrule
	\end{tabularx}
\end{table}
...
\begin{enumerate}
	\item What knowledge and skills will the team collectively need to acquire to successfully complete this
	      ...
	      Leon will need to acquire domain knowledge related to developing and deploying PWAs. Leon will also
	      improve on writing and documentation skills throughout the software engineering process. Leon will
	      also have the opportunity to improve on his presentation skills when presenting the project at the
	      capstone expo.
	...
	\item For each of the knowledge areas and skills identified in the previous question, what are at least
	      ...
	      To acquire the necessary knowledge to develop and deploy PWAs, Leon will conduct research into PWAs
	      through online resources and industry resources. To improve on writing and documentation skills,
	      Leon will refer to course and educational materials, industry resources and materials, and online
	      resources relevant to software engineering practices and processes. These skills will not only
	      contribute to the success of the project, but also to his future success in his career. The
	      methodologies listed to acquire the knowledge and skills will give the opportunity to explore a
	      variety of resources. Some of these resources are in line with those used in industry.
