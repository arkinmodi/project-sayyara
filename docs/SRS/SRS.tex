...
\begin{enumerate}
	\item [{LF}1.] The system shall adjust and scale to fit the physical screen size
	\item [{LF}2.] The system shall have fonts and colours that will allow users to easily read the text
	\item [{LF}3.] The system shall display dollar amounts rounded to 2 decimal places
\end{enumerate}

\subsection{Usability and Humanity Requirements}
\begin{enumerate}
	\item [{UH}1.] The system shall accessible by any desktop or mobile device and any operating system
	\item [{UH}2.] The system shall be accessible through the web browser and when the device is connected to internet
\end{enumerate}

\subsection{Performance Requirements}
\begin{enumerate}
	\item [{PR}1.] The system shall respond to the user's interactions within 0.5 seconds
\end{enumerate}

\subsection{Operational and Environmental Requirements}
\begin{enumerate}
	\item [{OE}1.] The system shall be able to operate on desktops and mobile devices
\end{enumerate}

\subsection{Maintainability and Support Requirements}
\begin{enumerate}
	\item [{MS}1.] The system shall be well documented
\end{enumerate}

\subsection{Security Requirements}
\begin{enumerate}
	\item [{SR}1.] The system shall keep user's data private
	\item [{SR}2.] The system shall limit the data shown to user's on a needs to know basis
\end{enumerate}

\subsection{Cultural Requirements}
\begin{enumerate}
	\item [{CR}1.] The system shall not use any text or images that will offend anyone that will use it
	\item [{CR}2.] The system will use Canadian English
\end{enumerate}

\subsection{Legal Requirements}
\begin{enumerate}
	\item [{LR}1.] The system shall not contain any assets which infringe on copyright claims
\end{enumerate}

\subsection{Health and Safety Requirements}
N/A This section is not in the original Volere template, but health and safety are issues that
should be considered for every engineering project.
