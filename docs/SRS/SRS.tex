	      ...
	      \begin{enumerate}
		      \item [{VP1}.1] Viewpoint: Vehicle Owner
		            \begin{enumerate}
			            ...
			            \item The system shall allow the user to cancel and exit the registration process to return to the
			                  login/sign up page
		            \end{enumerate}
	      \end{enumerate}
	      \begin{enumerate}
		      ...
		      \item [{VP1}.1] Viewpoint: Vehicle Owner
		            \begin{enumerate}
			            ...
			            \item The system shall transition to the vehicle owner landing page after the login process is complete
			                  and successful
			            \item The system shall allow the user to cancel and exit the login process to return to the login/sign up
			                  page
		            \end{enumerate}
	      \end{enumerate}
	      \begin{enumerate}
