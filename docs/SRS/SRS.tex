...
\begin{table}[H]
	...
	\begin{tabular}{|p{0.1\textwidth}|p{0.4\textwidth}|p{0.2\textwidth}|p{0.2\textwidth}|}
		...
		\hline
		1               & Create shop account     & Auto repair shop owner                            & Shop information          \\
		\hline
		2               & Create employee profile & Auto repair shop owner\nAuto repair shop employee & Employee information      \\
		\hline
	\end{tabular}
\end{table}
