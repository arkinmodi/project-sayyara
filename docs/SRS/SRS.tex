...
\begin{table}[hp]
	...
	\begin{tabularx}{\textwidth}{llX}
		...
		October 3, 2022    & Arkin Modi            & Add planning of the development phases section                                     \\
		\bottomrule
	\end{tabularx}
\end{table}
...
\begin{enumerate}
	\item[Phase 1] Initial development of application and documentation
	\item[Phase 2] Refinement of application and documentation
\end{enumerate}
