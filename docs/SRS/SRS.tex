...
% 		\hline
% 		1               & Create shop account               & Auto repair shop owner    & Shop information (in)       \\
% 		\hline
% 		2               & Create employee profile           & Auto repair shop owner    & Employee information (in)   \\
% 		                &                                   & Auto repair shop employee &                             \\
% 		\hline
% 		3               & Login                             & Auto repair shop owner    & Username and password (in)  \\
% 		                &                                   & Auto repair shop employee & Authentication (out)        \\
% 		\hline
% 		4               & Create services                   & Auto repair shop owner    & Service information (in)    \\
% 		\hline
% 		5               & View services                     & Auto repair shop owner    & List of services (out)      \\
% 		                &                                   & Auto repair shop employee &                             \\
% 		                &                                   & Vehicle owner             &                             \\
% 		\hline
% 		6               & Create appointment availabilities & Auto repair shop owner    & Dates of availability (in)  \\
% 		\hline
% 		7               & View appointment availabilities   & Auto repair shop owner    & Dates of availability (out) \\
% 		                &                                   & Auto repair shop employee &                             \\
% 		                &                                   & Vehicle owner             &                             \\
% 		\hline
% 		8 &  & & \\
...
\begin{enumerate}
	...
	\item System registers user as a shop and prompts additional information, such as shop name and location
	\item User enters additional information necessary
