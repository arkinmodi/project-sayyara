...
\begin{table}[H]
	...
	\begin{tabular}{ |p{5cm}|p{10.5cm}|  }
		...
		\hline
		Amazon Web Service (AWS)              & Amazon Web Service is a cloud computing provider.                        \\
		\hline
		Amazon Web Service (AWS) Lambda       & Amazon Web Service's serverless compute unit.                            \\
		\hline
		Chrome                                & Google Chrome is a cross-platform web browser developed by Google.       \\
		\hline
		Sayyara                               & Sayyara is the name of the company the supervisor runs and
