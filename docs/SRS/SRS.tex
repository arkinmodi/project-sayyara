...
\[(\exists a, b \in \text{users}, a.\text{role}, b.\text{role} \in \text{employee} | a \neq b \bullet a.\text{view}(b.\text{profile}) \implies false) \]
Employees cannot view one another's profiles

\[(\exists a \in \text{users}, a.\text{role}, b.\text{role} \in \text{employee} | a \neq b \bullet a.\text{edit}(b) \implies false) \]
Employees cannot modify or edit another user

\[(\exists a \in \text{users}, a.\text{role} \in \text{owner} | \forall x \in \users, x.\text{shop} = a.\text{shop} \bullet a.edit(x) \and a.view(x.\text{profile}) \implies true) \]
