...
\begin{table}[hp]
	...
	\begin{tabularx}{\textwidth}{llX}
		...
		October 3, 2022    & Leon So               & Add functional requirements for employees shop management \\
		\bottomrule
	\end{tabularx}
\end{table}
...
\subsubsection{Shop Management}
\begin{enumerate}
	\item [{BE}1.] The shop owner wants to invite and employee to their shop
	      \begin{enumerate}
		      \item [{VP1}.1] Viewpoint: Vehicle Owner
		            \begin{enumerate}
			            \item[] N/A
