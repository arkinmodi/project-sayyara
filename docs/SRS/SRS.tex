...
\begin{table}[hp]
	...
	\begin{tabularx}{\textwidth}{llX}
		...
		October 4, 2022    & Joy Xiao              & Add services FRs                                   \\
    \bottomrule
	\end{tabularx}
\end{table}
...
\begin{enumerate}[resume*=business_events]
		      ...
		      \item Viewpoint: Auto Repair Shop Owner
		            \begin{enumerate}
			            ...
			            \item The system shall allow the user to enter the parts used for the service including quantity,
			                  condition, build, and cost per part
			            \item The system shall allow the user to enter the total price for the service
		            \end{enumerate}
	...
	\item The user wants to search for shop services
	      \begin{enumerate}[VP\arabic*.]
		      \item Viewpoint: Vehicle Owner
		            \begin{enumerate}
