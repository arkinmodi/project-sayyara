...
\begin{enumerate}[resume*=business_events]
	...
	\item The user wants to assign an employee to a work order
	      \begin{enumerate}[VP\arabic*.]
		      \item Viewpoint: Vehicle Owner
		            \begin{enumerate}
			            \item[] N/A
		      ...
		      \item Viewpoint: Auto Repair Shop Owner
		            \begin{enumerate}
			            ...
			            \item The system shall allow the user to enter the employee name
			            \item The system shall update the work order with the entered employee name
		            \end{enumerate}
		      \item Viewpoint: Auto Repair Shop Employee
		            \begin{enumerate}
			            \item The system shall list the open work orders
