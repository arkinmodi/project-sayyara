...
In the current design of the product, the product will be implemented in a cloud hosted serverless
environment. In this specific case, it would be AWS Lambda.
