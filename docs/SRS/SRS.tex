...
\begin{enumerate}[{BE}1.]
	\item The user owner wants to sign up for an account
...
\begin{enumerate}[{BE}2.]
	\item The user owner wants to login to their account
	      \begin{enumerate}[{VP1}.1]
		      \item Viewpoint: Vehicle Owner
		            \begin{enumerate}
			            \item The system shall allow the user to enter their email and password
			            \item The system shall transition to the user landing page after the registration login is complete and
			                  successful
