...
\subsubsection{Services}
\begin{enumerate}[resume*=business_events]
	\item The user wants to add a basic auto shop service to the shop profile
	      \begin{enumerate}[VP\arabic*.]
		      \item Viewpoint: Vehicle Owner
		            \begin{enumerate}
			            \item[] N/A
...
\begin{enumerate}[MS\arabic*.]
	\item The system shall be well documented with a proper read.me and will have appropriate comments to
	      ensure maintainability of the system. Any source files will have the author of the file and date
	      edited. Any methods within a file will have the author, edited date, param, and return values
	      documented.
\end{enumerate}

\subsection{Security Requirements}
\begin{enumerate}[SR\arabic*.]
	\item The system shall keep user's data private. User passwords will be hashed in transit and at rest to
