...
\begin{longtable}{p{0.2\textwidth} p{0.2\textwidth} p{0.5\textwidth}}
	...
	April 4, 2023      & Leon So               & Update context of work diagram, update events to remove email service              \\
	April 5, 2023      & Timothy Choy          & Update Shop Lookup BE and Individual Product Use Cases                             \\
	April 5, 2023      & Leon So               & Remove diagram for employee email invitations                                      \\
	\bottomrule
\end{longtable}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|p{3.5cm}|c|p{3.5cm}|}
		...
		\hline
		22                    & View work order details           & User           & Database        \\
		\hline
		23                    & Invite employee to shop           & User           & Database        \\
		\hline
		24                    & Search for employee               & User           & Database        \\
		\hline
		25                    & View list of employees            & User           & Database        \\
		\hline
		26                    & Remove employee from shop         & User           & Database        \\
		\hline
		27                    & Add shop services to shop profile & User           & Database        \\
		\hline
		28                    & Search for service                & User           & Database        \\
		\hline
		29                    & Edit service type                 & User           & Database        \\
		\hline
		30                    & Delete service type               & User           & Database        \\
		\hline
	\end{tabular}
\end{table}
	      ...
	      \begin{enumerate}[VP\arabic*.]
		      \item Viewpoint: Vehicle Owner
		            \begin{enumerate}
			            ...
			            \item The system shall allow the user to filter by location range
