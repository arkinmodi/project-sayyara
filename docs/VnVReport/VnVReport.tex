...
As defined in the defined in the
\href{https://github.com/arkinmodi/project-sayyara/blob/main/docs/VnVPlan/VnVPlan.pdf}{VnV Plan},
the tests reported aim to verify and validate functional and nonfunctional requirements as listed
in the \href{https://github.com/arkinmodi/project-sayyara/blob/main/docs/SRS/SRS.pdf}{SRS}.
