...
\begin{enumerate}
	...
	\item \textbf{FRT-BE2-1}
	      ...
	      How test will be performed: The tester will log in to an existing customer account using valid login
	      credentials
	...
	\item \textbf{FRT-BE2-3}
	      ...
	      How test will be performed: The tester will log in to an existing employee account using valid login
	      credentials
