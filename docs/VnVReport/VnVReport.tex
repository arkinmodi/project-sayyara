...
\begin{enumerate}
	...
	\item \textbf{FRT-BE4-2}
	      ...
	      Output: A new appointment request is created with service details. Shop Owner/Employee
	...
	\item \textbf{FRT-BE4-3}
	      ...
	      Output: Appointment booking displayed for Shop Owner/Employee accounts and Customer
	      account
	...
	\item \textbf{FRT-BE5-1}
	      ...
	      Output: A new appointment request is made with the new time slot. Shop Owner/Employee
	      Accounts will receive the appointment request
	...
	\item \textbf{FRT-BE6-1}
	      ...
	      Output: The appointment booking is cancelled and removed from the customer and shop
...
\begin{enumerate}
	...
	\item \textbf{FRT-BE31-1}
	      ...
	      Output: Service is removed from the shop profile. Other services that were not deleted
