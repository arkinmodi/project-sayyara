...
\begin{landscape}
	...
	\begin{longtable}{|c|c|c|c|c|c|c|c|c|c|}
		...
		\toprule
        \textbf{Module} & \multicolumn{2}{c|}{\textbf{Create}} & \multicolumn{2}{c|}{\textbf{Get}} & \multicolumn{3}{c|}{\textbf{Update}} & \multicolumn{2}{c|}{\textbf{Delete}}                                                                                                             \\
		~ & \textbf{Positive}                    & \textbf{Invalid Body}             & \textbf{Positive}                    & \textbf{Invalid ID}                  & \textbf{Positive} & \textbf{Invalid ID} & \textbf{Invalid Body} & \textbf{Positive} & \textbf{Invalid ID} \\
		\midrule
        User Module & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & ~ & ~ & ~ & ~ & ~ \\
		\bottomrule
        \multicolumn{10}{c}{$\checkmark$ = Pass, X = Fail, $\square$ = N/A} \\
        \bottomrule
	\end{longtable}
\end{landscape}
