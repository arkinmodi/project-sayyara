...
endpoints, thereby exposing data that does not belong to the user. As a result, the endpoint has been
revised to return an appropriate set of information that does not expose more information that
